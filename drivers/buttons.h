...
#define BUTTON_GPIO_UP_PERIPH     SYSCTL_PERIPH_GPIOE
#define BUTTON_GPIO_UP_BASE       GPIO_PORTE_BASE

#define BUTTON_GPIO_DOWN_PERIPH     SYSCTL_PERIPH_GPIOD
#define BUTTON_GPIO_DOWN_BASE       GPIO_PORTD_BASE
