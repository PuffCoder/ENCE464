...
ButtonsPoll(uint8_t *pui8Delta, uint8_t *pui8RawState)
{
    ...
    ui32Data = (GPIOPinRead(BUTTON_GPIO_UP_BASE, UP_BUTTON));
    if(pui8RawState)
    {
...
ButtonsInit(void)
{
    ...
    MAP_SysCtlPeripheralEnable(BUTTON_GPIO_UP_PERIPH);
    MAP_SysCtlPeripheralEnable(BUTTON_GPIO_DOWN_PERIPH);
    ...
    MAP_GPIODirModeSet(BUTTON_GPIO_UP_BASE, UP_BUTTON, GPIO_DIR_MODE_IN);
    MAP_GPIOPadConfigSet(BUTTON_GPIO_UP_BASE, UP_BUTTON,
                         GPIO_STRENGTH_2MA, GPIO_PIN_TYPE_STD_WPU);

    MAP_GPIODirModeSet(BUTTON_GPIO_DOWN_BASE, UP_BUTTON, GPIO_DIR_MODE_IN);
    MAP_GPIOPadConfigSet(BUTTON_GPIO_DOWN_BASE, DOWN_BUTTON,
                         GPIO_STRENGTH_2MA, GPIO_PIN_TYPE_STD_WPU);
    ...
    g_ui8ButtonStates = MAP_GPIOPinRead(BUTTON_GPIO_UP_BASE, UP_BUTTON);
    g_ui8ButtonStates = MAP_GPIOPinRead(BUTTON_GPIO_DOWN_BASE, DOWN_BUTTON);
}
